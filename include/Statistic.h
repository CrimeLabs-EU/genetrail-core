...
#ifndef GENETRAILCORE_STATISTIC_H
#define GENETRAILCORE_STATISTIC_H
 ...
 */
        ...
        std::tuple<value_type, value_type, size_t> mean_var_size(InputIterator begin, InputIterator end) {
            ...
            if (size <= 1) { return std::make_tuple(mean, value_type(), size); }
 ...
 */
        ...
        value_type skewness(InputIterator begin, InputIterator end) {
            ...
            if (sd == 0) { return value_type(); }

            for (; begin != end; ++begin) { skewness += std::pow((*begin - mean) / sd, 3); }
 ...
 */
        template<typename value_type, typename InputIterator>
        std::vector<value_type> absolute_deviations(InputIterator begin, InputIterator end, value_type ave) {
            std::vector<value_type> ads;
            ads.reserve(std::distance(begin, end));

            for (auto it = begin; it != end; ++it) { ads.emplace_back(std::abs(*it - ave)); }
 ...
 */
        template<typename value_type, typename InputIterator>
        value_type cov(InputIterator first_begin, InputIterator first_end, InputIterator second_begin, InputIterator second_end, value_type mean1,
                       value_type mean2) {
            ...
            for (; first_begin != first_end; ++first_begin, ++second_begin) { cov += (*first_begin - mean1) * (*second_begin - mean2); }
 ...
 */
        ...
        value_type mean_larger_than(value_type threshold, InputIterator1 first_begin, InputIterator1 first_end, InputIterator2 second_begin,
 ...
 */
        ...
        value_type pearson_correlation(InputIterator first_begin, InputIterator first_end, InputIterator second_begin, InputIterator second_end) {
            ...
            value_type covar = cov(first_begin, first_end, second_begin, second_end, std::get<0>(mvs1), std::get<0>(mvs2));

            return covar / (std::sqrt(std::get<1>(mvs1)) * std::sqrt(std::get<1>(mvs2)));
        }
        ...
        std::vector<int> ranks(InputIterator begin, InputIterator end) {
            ...
            for (auto it = begin; it != end; ++it) {
                for (size_t i = 0; i < tmp.size(); ++i) {
                    if (*it == *(tmp.begin() + i)) { ranks.push_back(i); }
                }
            }
            return ranks;
        }
 ...
 */
        ...
        value_type spearman_correlation(InputIterator first_begin, InputIterator first_end, InputIterator second_begin, InputIterator second_end) {
            ...
            return pearson_correlation<value_type, std::vector<int>::iterator>(first_ranks.begin(), first_ranks.end(), second_ranks.begin(),
                                                                               second_ranks.end());
        }
 ...
 */
        template<typename value_type, typename InputIterator>
        value_type kendall_tau_correlation(InputIterator first_begin, InputIterator first_end, InputIterator second_begin, InputIterator second_end) {
            ...
            int counter = 0;
            for (int rank: first_ranks) { rank_map[rank] = counter++; }
            ...
            value_type denominator = std::sqrt((greater_count + less_count + x_equal_count) * (greater_count + less_count + y_equal_count));
 ...
 */
        template<typename value_type, typename InputIterator1, typename InputIterator2>
        value_type log_mean_fold_quotient(InputIterator1 begin1, InputIterator1 end1, InputIterator2 begin2, InputIterator2 end2) {
 ...
 */
        template<typename value_type, typename InputIterator1, typename InputIterator2>
        value_type log_median_fold_quotient(InputIterator1 begin1, InputIterator1 end1, InputIterator2 begin2, InputIterator2 end2) {
            return std::log(median<value_type, InputIterator1>(begin1, end1)) - std::log(median<value_type, InputIterator2>(begin2, end2));
        }
 ...
 */
        template<typename value_type, typename InputIterator1, typename InputIterator2>
        value_type mean_fold_quotient(InputIterator1 begin1, InputIterator1 end1, InputIterator2 begin2, InputIterator2 end2) {
...
*/
        template<typename value_type, typename InputIterator1, typename InputIterator2>
        value_type mean_fold_difference(InputIterator1 begin1, InputIterator1 end1, InputIterator2 begin2, InputIterator2 end2) {
            return mean<value_type, InputIterator1>(begin1, end1) - mean<value_type, InputIterator2>(begin2, end2);
        }
 ...
 */
        template<typename value_type, typename InputIterator1, typename InputIterator2>
        value_type median_fold_quotient(InputIterator1 begin1, InputIterator1 end1, InputIterator2 begin2, InputIterator2 end2) {
            return median<value_type, InputIterator1>(begin1, end1) / median<value_type, InputIterator2>(begin2, end2);
        }
 ...
 */
        template<typename value_type, typename InputIterator1, typename InputIterator2>
        value_type median_fold_difference(InputIterator1 begin1, InputIterator1 end1, InputIterator2 begin2, InputIterator2 end2) {
            return median<value_type, InputIterator1>(begin1, end1) - median<value_type, InputIterator2>(begin2, end2);
        }
...
#endif//GENETRAILCORE_STATISTIC_H
